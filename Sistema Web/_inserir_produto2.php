...
<?php } ?>
	...
	<a href="negado_editar.php?nome=<?php echo $nome?>&cpf=<?php echo $cpf ?>&rg=<?php echo $rg ?>&email=<?php echo $email ?>&tag=<?php echo $tag ?>&telefone=<?php echo $telefone ?>&sexo=<?php echo $sexo ?>&id=<?php echo $id ?>""role="button" class="btn btn-sm  btn-warning" style="color: #fff">Voltar</a>
...
<div style="padding-top: 20px">	
<center> 
<a href="negado_editar.php?nome=<?php echo $nome?>&cpf=<?php echo $cpf ?>&rg=<?php echo $rg ?>&email=<?php echo $email ?>&tag=<?php echo $tag ?>&telefone=<?php echo $telefone ?>&sexo=<?php echo $sexo ?>&id=<?php echo $id ?>"" role="button" class="btn btn-sm btn-primary">Voltar</a>
</center>
</div>
