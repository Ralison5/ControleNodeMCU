...
<form  action="Aprovar_usuarios2.php" method="post" submit="Cadastrar">
...
<form action="aprovar_varios_deletar2.php" method="post" submit>
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col">Atribuir privilegios</th>
...
?>
    ...
    <td>
	    <a class="btn btn-success btn-sm" style="width:130px" href="confirmar_usuario2.php?id=<?php echo $id_usuario ?>&nivel=1" role="button">Administrador (1)</a>
        <a class="btn btn-secondary btn-sm" style="width:130px"  href="confirmar_usuario2.php?id=<?php echo $id_usuario ?>&nivel=2" role="button">Conferente (2)</a>
    </td>
	<td>
	<a class="btn btn-warning btn-sm" style="width:130px" href="aprovar_editar2.php?id=<?php echo $id_usuario ?>" role="button"><i class="far fa-edit"></i></i>&nbsp;Editar</a>
	<a class="btn btn-danger btn-sm" style="width:130px" href="aprovar_deletar2.php?id=<?php echo $id_usuario ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Excluir</a>
	</td>
    </tr>  
...
$sql= "SELECT `nome`, `email`,`id_usuario`,`nivel` FROM `usuario_externo` WHERE `nome` like '%$search%' AND nivel != 0 or `email` like '%$search%' AND nivel != 0";
$busca=mysqli_query($conexao,$sql);
while ($array=mysqli_fetch_array($busca)) {
  $nome=$array['nome'];
  $email=$array['email'];
