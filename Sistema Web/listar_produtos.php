...
<a href="listar_produtos.php" role="button" class="btn btn-sm btn-primary">Atualizar</a>
<a href="alternar_ambiente3.php" role="button" class="btn btn-sm btn-primary">Voltar</a>
</div>
<h5>Lista de cadastros</h5>

<form  action="listar_produtos.php" method="post" submit="Cadastrar">
...
<form action="deletar_varios_produtos.php" method="post" submit>
...
?>
	...
	<?php if($nivel == 1){ ?>
    <td>
	<a class="btn btn-warning btn-sm" style="width:130px" href="editar_produto.php?id=<?php echo $id ?>" role="button"><i class="far fa-edit"></i>&nbsp;Editar </a>
    <a class="btn btn-danger btn-sm" style="width:130px" href="deletar_produto.php?id=<?php echo $id ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Excluir</a>
	</td>
	<?php } ?>
    </tr> 
