...
if($tag != NULL  && $id_local != NULL){
	...
	if(0 < $valor1 && $valor2 > 0){
	  ...
	  inserir($tag, $id_local,$data_inicial,$data_final,$hora_inicial,$hora_final);
	        $cont=$cont+1;
	}
	 }
...
<center>
	...
	<a href="selecionar_usuarios.php?id_local=<?php echo $id_local?>" class="btn btn-sm  btn-warning" style="color: #fff">Voltar</a>
	</div>
</center>
</div>
