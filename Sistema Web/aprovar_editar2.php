...
<a href="Aprovar_usuarios2.php" role="button" class="btn btn-sm btn-primary">voltar</a>
</div>
<h4>Formulário de cadastro</h4>
<form action="aprovar_atualizar2.php" method="post" submit style ="margin-top: 20px;">
<?php
